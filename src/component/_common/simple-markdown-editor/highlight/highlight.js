    ...
    function upgradePluginAPI(plugin) {
      ...
      if (
        ...
        plugin["before:highlightElement"] = (data) => {
          plugin["before:highlightBlock"]({ block: data.el, ...data });
        };
      }
      if (plugin["after:highlightBlock"] && !plugin["after:highlightElement"]) {
        plugin["after:highlightElement"] = (data) => {
          plugin["after:highlightBlock"]({ block: data.el, ...data });
        };
      }
    }
...
(function () {
  let hljsGrammar = (function () {
    ...
    let hexDigits = "[0-9a-fA-F](_*[0-9a-fA-F])*";
    let NUMERIC = {
      className: "number",
      variants: [
